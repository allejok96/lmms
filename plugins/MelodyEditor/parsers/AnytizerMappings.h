...
#ifndef MELODY_EDITOR_ANYTIZER_MAPPINGS_H
#define MELODY_EDITOR_ANYTIZER_MAPPINGS_H
...
typedef std::vector<std::pair<QString, QString>> ReplacementMapping;

constexpr auto HIGHER_OCTAVE_MARKER = "*";
constexpr auto NOTE_LENGTH_MARKER = "-";
constexpr auto SEPARATOR_MARKER = "|";

const ReplacementMapping DEFAULT_REPLACEMENTS = {
	{"™", "#"},

	// ("‘", replace = SpecialKeys.LOWER_OCTAVE_NOTATION }); // appears in front

	// common symbols
	// ("*", replace = sk.HIGHER_OCTAVE_NOTATION }); // not necessary | same destination
	...
	{"º", HIGHER_OCTAVE_MARKER},
	{"°", HIGHER_OCTAVE_MARKER},
	{"’", HIGHER_OCTAVE_MARKER}, // octave change!!
	...
	{"-", NOTE_LENGTH_MARKER}, // ??
	{"-", NOTE_LENGTH_MARKER},
	{"_", NOTE_LENGTH_MARKER},
	{"—", NOTE_LENGTH_MARKER},
	{"~", NOTE_LENGTH_MARKER},
	{"ऽ", NOTE_LENGTH_MARKER}, // avagraha
 ...
 */
const AnytizerMapping ENGLISH_MAPPING = {
	"Western / English",
	"ns-english",
	{
...
const AnytizerMapping CARNATIC_MAPPING = {
	"SARGAM / Carnatic",
	"ns-carnatic",
	{
		{"S", "C"},
 ...
 */
const AnytizerMapping HINDUSTANI_MAPPING = {
	"SARGAM / Hindustani",
	"ns-hindustani",
	{
...
#endif // MELODY_EDITOR_ANYTIZER_MAPPINGS_H
